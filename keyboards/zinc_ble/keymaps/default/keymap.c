...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = { \
   ...
   * |------+------+------+------+------+------|             |------+------+------+------+------+------|
   * | Esc  |ADJUST| GUI  | Alt  |LOWER |Space |             | Space| RAISE| Left | Down |  Up  | Right|
   * `-----------------------------------------'             `-----------------------------------------'
   */
[_QWERTY] = LAYOUT(
   ...
   */
    [_ADJUST] =  LAYOUT( \
      AD_WO_L, RESET,   RGBRST,  AU_ON, USB_DIS, USB_EN,                  ADV_ID0, ADV_ID1, ADV_ID2,  ADV_ID3, ADV_ID4,  BATT_LV, \
      ENT_DFU, RGB_TOG, RGB_HUI, RGB_SAI, RGB_VAI, AG_NORM,                   AG_SWAP, KC_MINS, KC_EQL,  KC_PSCR, KC_SLCK, KC_PAUS,\
      _______, RGB_MOD, RGB_HUD, RGB_SAD, RGB_VAD, BLE_EN,                   DEL_ID0, DEL_ID1, DEL_ID2, DEL_ID3, DEL_ID4, BLE_DIS,\
      DELBNDS, _______, _______, EISU,    EISU,    EISU,                      KANA,    KANA,    KC_HOME, KC_PGDN, KC_PGUP, KC_END\
      )
};
